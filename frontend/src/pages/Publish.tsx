...
function TextEditor ({onChange}: {onChange: (e: ChangeEvent<HTMLTextAreaElement>) => void}) {
    return <div className="mt-3">
       <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 py-3 ">
           ...
           <div className="px-4 py-2 bg-white rounded-b-lg ">
               ...
               <textarea onChange={onChange} id="editor" rows={8}  className="focus:outline-none block w-full px-0 py-2 text-sm text-gray-800 bg-white border-0  focus:ring-0 dark:text-black dark:placeholder-gray-400" placeholder="Write an article..." required ></textarea>
           </div>
       </div>
    </div>
